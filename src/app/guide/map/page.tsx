...
export const metadata: Metadata = {
  title: 'Concept Map — Introduction to Center Study',
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-10">
      <div className="mb-8">
        ...
        <p className="text-xs font-mono text-gray-400 uppercase tracking-widest mt-4 mb-2">Layer IV · Visual</p>
        <h1 className="text-2xl sm:text-3xl font-bold mb-3">Concept Map</h1>
      ...
      <div className="flex gap-4 mb-6 text-xs text-gray-400">
        <span><strong className="text-gray-700">{MAP_NODES.length}</strong> concepts</span>
        <span><strong className="text-gray-700">{MAP_EDGES.length}</strong> connections</span>
        <span><strong className="text-gray-700">3</strong> tiers</span>
      </div>
      ...
      <section className="mt-10">
        <h2 className="text-xs font-mono text-gray-400 uppercase tracking-widest mb-4">All Concepts</h2>
          ...
          {CONCEPTS.map((c) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-sm text-gray-700 group-hover:text-blue-600 transition-colors">{c.title}</span>
                <span className="text-xs text-gray-400 ml-auto hidden sm:block">{c.relations.length} relations</span>
              </Link>
            );
          })}
        </div>
