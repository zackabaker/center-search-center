    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <header className="max-w-3xl mx-auto px-4 pt-14 pb-10 text-center">
        ...
        <div className="flex items-center justify-center gap-1.5 mb-6 flex-wrap">
          ...
          >
            <span className="text-[10px] font-mono text-gray-400 dark:text-gray-500 uppercase tracking-widest">Mimetic Theory</span>
            <span className="text-xs font-semibold text-gray-700 dark:text-gray-300 group-hover:text-amber-700 dark:group-hover:text-amber-400 transition-colors">René Girard</span>
          </Link>
          ...
          >
            <span className="text-[10px] font-mono text-gray-400 dark:text-gray-500 uppercase tracking-widest">Generative Anthropology</span>
            <span className="text-xs font-semibold text-gray-700 dark:text-gray-300 group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors">Eric Gans</span>
          </Link>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 text-gray-300 dark:text-gray-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          </svg>
          ...
          >
            <span className="text-[10px] font-mono text-gray-400 dark:text-gray-500 uppercase tracking-widest">Center Study</span>
            <span className="text-xs font-semibold text-gray-700 dark:text-gray-300 group-hover:text-violet-700 dark:group-hover:text-violet-400 transition-colors">Katz · Bouvard</span>
          </Link>
        </div>
