    ...
    <main className="max-w-5xl w-full mx-auto px-4 py-8 sm:py-12 pb-24 sm:pb-12">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3 flex-wrap text-xs">
          ...
          <span className="text-gray-200 dark:text-gray-800">·</span>
          <Link href="/glossary" className="inline-flex items-center gap-1.5 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors font-medium">
