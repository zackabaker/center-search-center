...
curl -X POST https://center.study/api/embed \\
  -H "content-type: application/json" -d '{"q": "deferral"}'`}</pre>
      ...
      <p className={P}>
        ...
        to partner origins — currently center.study and katechon.design. Server-to-server calls are rate-limited.
        Want your origin allowlisted? Ask via <Link href="/follow" className="text-blue-600 dark:text-blue-400 hover:underline">the contact channels</Link>.
