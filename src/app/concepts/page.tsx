...
// Static route — the glossary lives at /concepts/glossary (the old
// ?view=glossary read searchParams on the server, which forced per-request
// rendering of BOTH tabs and shipped the ~1 MB glossary payload to everyone).
export default function ConceptsPage() {
  return (
    <main className="max-w-5xl w-full mx-auto px-4 py-8 sm:py-12">
      <ConceptsHeader active="core" />
